...
namespace Zuul
{
    public class Game
    {
        ...
        private void CreateRooms()
        {
            ...
            pub.Chest.Put("handgun", new Item(4, " a gun dealing damage "));
        ...
        private void Take(Command take)
        {
            if (!take.HasSecondWord())
            {
                Console.WriteLine(" take what? ");
                return;
            }

            string itemName = take.GetSecondWord();

            Item item = player.TakeFromChest()

            if (take.HasSecondWord())
            {
                Console.WriteLine(" you have taken " + itemName);
